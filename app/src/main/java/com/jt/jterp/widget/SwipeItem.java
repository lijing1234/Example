...
public class SwipeItem extends LinearLayout {
    ...
    public SwipeItem(View contentView, View menuView) {
    ...
    private SwipeItem(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    private SwipeItem(Context context) {
        super(context);
    }
